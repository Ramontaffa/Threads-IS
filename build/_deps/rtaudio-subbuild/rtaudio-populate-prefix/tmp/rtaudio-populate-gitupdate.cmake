...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "6.0.1"
  WORKING_DIRECTORY "/Users/arthurcavalcanti/Documents/dev/audio-threads/build/_deps/rtaudio-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/arthurcavalcanti/Documents/dev/audio-threads/build/_deps/rtaudio-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/arthurcavalcanti/Documents/dev/audio-threads/build/_deps/rtaudio-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
